          ...
          <div class="col-lg-8 entries">
            ...
            <article class="entry">
              ...
              <div class="entry-meta">
                <ul>
                  <li class="d-flex align-items-center"><i class="bi bi-person"></i> <a href="blog-single.html">Jean-Noel Tokpa</a></li>
          ...
          <div class="col-lg-4">
            ...
            <div class="sidebar">
              ...
              <div class="sidebar-item categories">
                <ul>
                  <li><a href="#">Code <span>(25)</span></a></li>
                  <li><a href="#">Developpement web <span>(12)</span></a></li>
                  <li><a href="#">JavaScript <span>(5)</span></a></li>
                  <li><a href="#">Intelligence Artificielle <span>(22)</span></a></li>
                  <li><a href="#">Reseau <span>(8)</span></a></li>
                  <li><a href="#">Python <span>(14)</span></a></li>
                </ul>
              </div><!-- End sidebar categories-->

              <h3 class="sidebar-title">Psots récents</h3>
              <div class="sidebar-item recent-posts">
                <div class="post-item clearfix">
                  <img src="{{asset('img/blog/blog-recent-1.jpg')}}" alt="">
                  <h4><a href="blog-single.php">post 1</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{asset('img/blog/blog-recent-2.jpg')}}" alt="">
                  <h4><a href="blog-single.php">Post 2</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{asset('img/blog/blog-recent-3.jpg')}}" alt="">
                  <h4><a href="blog-single.php">Post 3</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{asset('img/blog/blog-recent-4.jpg')}}" alt="">
                  <h4><a href="blog-single.php">Psot 4</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>

                <div class="post-item clearfix">
                  <img src="{{asset('img/blog/blog-recent-5.jpg')}}" alt="">
                  <h4><a href="blog-single.php">Post 5</a></h4>
                  <time datetime="2020-01-01">Jan 1, 2020</time>
                </div>
